...
let Workspace: GraphQLObjectType<Schema.Workspace, ResolverContext>;
let Task: GraphQLObjectType<Schema.Task, ResolverContext>;
let Artifact: GraphQLUnionType;
let Editor: GraphQLInterfaceType;
let TagProperty: GraphQLInterfaceType;
let Status: GraphQLObjectType<Schema.Status, ResolverContext>;
let Priority: GraphQLObjectType<Schema.Priority, ResolverContext>;
let Label: GraphQLObjectType<Schema.Label, ResolverContext>;
let Viewer: GraphQLObjectType<Schema.Viewer, ResolverContext>;
let Query: GraphQLObjectType<undefined, ResolverContext>;
let Node: GraphQLInterfaceType;
let PageInfo: GraphQLObjectType<Schema.PageInfo, ResolverContext>;
...
let Mutation: GraphQLObjectType<undefined, ResolverContext>;
let UpdateUserInput: GraphQLInputObjectType;
let UpdateWorkspaceInput: GraphQLInputObjectType;
let LabelConnection: GraphQLObjectType<Schema.LabelConnection, ResolverContext>;
let LabelEdge: GraphQLObjectType<Schema.LabelEdge, ResolverContext>;
let LabelFilterInput: GraphQLInputObjectType;
let PriorityConnection: GraphQLObjectType<Schema.PriorityConnection, ResolverContext>;
let PriorityEdge: GraphQLObjectType<Schema.PriorityEdge, ResolverContext>;
let PriorityFilterInput: GraphQLInputObjectType;
let StatusConnection: GraphQLObjectType<Schema.StatusConnection, ResolverContext>;
let StatusEdge: GraphQLObjectType<Schema.StatusEdge, ResolverContext>;
...
let TaskConnection: GraphQLObjectType<Schema.TaskConnection, ResolverContext>;
let TaskEdge: GraphQLObjectType<Schema.TaskEdge, ResolverContext>;
...
Artifact = new GraphQLUnionType({
  name: "Artifact",
  types: () => [Task, Workspace, User],
});
Editor = new GraphQLInterfaceType({
  name: "Editor",
  fields: () => ({
